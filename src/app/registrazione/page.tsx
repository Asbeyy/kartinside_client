...
function UserInformationsForm() {
  ...
  function sendForm() {
    ...
    const pnascita = document.querySelector(".pnascitav");
    const naznascita = document.querySelector(".naznascitav");
    ...
    const scadenza_doc = document.querySelector(".sdocumentov");
    ...
    if (
      (indirizzo as HTMLInputElement).value === "" ||
      ...
      (telefono as HTMLInputElement).value === "" ||
      ...
      (scadenza_doc as HTMLInputElement).value === "" ||
      (pnascita as HTMLInputElement).value === "" ||
      (naznascita as HTMLInputElement).value === "" 
    ) {
    ...
    const data = {
      ...
      pnascita: (pnascita as HTMLInputElement).value,
      naznascita: (naznascita as HTMLInputElement).value,
      ...
      scadenza_doc: (scadenza_doc as HTMLInputElement).value,
    };
    ...
    fetch(`${urlAPI}/create/user`, {
      ...
      body: JSON.stringify({
        ...
        nato_a_provincia: data.pnascita,
        nato_a_nazione: data.naznascita,
        ...
        document_expiry: data.scadenza_doc,
      }),
    })
      .then((res) => res.json())
      .then((data) => {
      ...
      <form className="form-registration" action="">
        <div>
          ...
          <div className="container-personal-info">
            ...
            <div className="input-component">
              <label htmlFor="nome">Comune di nascita</label>
            ...
            <div className="input-component">
              <label htmlFor="nome">Nazione di nascita</label>
              <select className="naznascitav" name="" id="">
        ...
        <div>
          ...
          <div className="container-personal-info">
            ...
            <div className="input-component">
              ...
              <select className="paesev" name="" id="">
                <option value="it">Italia</option>
                <option value="ee">Estero</option>
              </select>
            </div>
        ...
        <div>
          ...
          <div className="input-component">
            <label htmlFor="nome">Scadenza Documento</label>
            <input type="date" className="sdocumentov" name="nome" id="nome" />
          </div>
          </div>
        </div>
      </form>
      ...
      {modalMinor && (
        <>
          <h2 style={{ textAlign: "center" }}>
            Informazioni Responsabile Legale
          </h2>
